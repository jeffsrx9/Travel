<template>
  <div class="home">
    ...
    <div class="hot">
      <router-link
        class="hot-city bdr-sm"
        v-for="(item, index) in ranCity"
        :key="item[0]"
        :to="`/ScenicSpot/F/${item[0]}/`"
      >
        <img class="hot-city-img" :src="getImgUrl(index + 1)" :alt="item[0]" />
...
import { cityLib, sloganLib } from "@/store/init";
import { dataFilter } from "@/utils/array";
